  ...
  return (
    <Stack p="md" gap="xxl">
      ...
      <AdaptiveSelect
        ...
        data={[
          { value: 'auto', label: t('Automatic by model') },
          { value: 'provider', label: t('One provider for all models') },
        ]}
        value={extension.webSearch.mode}
        onChange={(e) =>
          e &&
          setSettings({
            extension: {
      ...
      <AdaptiveSelect
        ...
        label={t(extension.webSearch.mode === 'auto' ? 'Fallback Search Provider' : 'Search Provider')}
        maw={320}
      />
      <Stack gap={4}>
